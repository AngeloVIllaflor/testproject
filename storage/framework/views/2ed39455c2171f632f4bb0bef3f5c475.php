                    ...
                    <div class="panel panel-default panel-btn-focused" id="p1"
                        ...
                        <div class="panel-heading">
                            <h2>
                                <ul class="nav nav-tabs">
                                    <li class="active">
                                        <a href="#tab-dept-visitor" id="tab-dept-visitor-link" data-toggle="tab">
                                            <i class="fa fa-user visible-xs"></i> 
                                            <span class="hidden-xs">Department Visitors Chart</span>
                                        </a>
                                    </li>
                                </ul>
                            </h2>
                        ...
                        <div class="panel-body">
                            <div class="tab-content">
                                <div id="tab-dept-visitor" class="tab-pane active">
                                    <div id="visitors-dept-stats" style="min-height:300px;"
                                        class="demo-graph graph-1"></div>
                                </div>
                            </div>
                        </div>
        ...
        $(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    $.plot('#visitors-dept-stats', datapie, {
                        series: {
                            pie: {
                                show: true,
                            }
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/danielmauricio/testproject/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>