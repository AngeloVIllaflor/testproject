                                ...
                                <nav role="navigation" class="widget-body">
                                    <ul class="acc-menu">
                                        <?php if(auth()->user()->role == 'admin'): ?>
                                            ...
                                            <li><a href="<?php echo e(route('admin.admin')); ?>"><i class="fa fa-briefcase"></i><span>Visitor Log</span></a></li>
                                            <li><a href="<?php echo e(route('admin.admin')); ?>"><i class="fas fa-file-alt"></i><span>Events</span></a></li>
                                        <?php else: ?>
                                            <li><a href="<?php echo e(route('admin.guard')); ?>"><i class="fas fa-file-alt"></i><span>Visitor Log</span></a></li>
...
<?php /**PATH /Users/danielmauricio/testproject/resources/views/layouts/admin.blade.php ENDPATH**/ ?>