...
<body>
    ...
    <div class="main-content">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php $__currentLoopData = $user->purposes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $purpose): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <?php if($loop->last): ?>
                                    <td>
                                        <?php if(!$user->logout_time): ?>
                                            <a href="<?php echo e(route('logout.user', $user->id)); ?>" class="logout-btn">Logout</a>
                                        <?php endif; ?>
                                    </td>
                                <?php else: ?>
                                    <td></td>
        ...
        <?php /**PATH D:\wamp\www\testproject\resources\views/guard/dashboard.blade.php ENDPATH**/ ?>